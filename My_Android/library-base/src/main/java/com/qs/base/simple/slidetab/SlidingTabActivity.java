package com.qs.base.simple.slidetab;
...
@Route(path = RouterActivityPath.Base.PAGER_SLIDE_TAB)
public class SlidingTabActivity extends AppCompatActivity implements OnTabSelectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (rtv_1_4 != null) {
            rtv_1_4.setBackgroundResource(R.color.msg_background_color);
            rtv_1_4.setBackgroundResource(R.color.msg_stroke_color);
        } else {
        ...
        if (rtv_2_3 != null) {
            if (rtv_2_3 instanceof MsgView) {
                rtv_2_3.setBackgroundResource(R.color.msg_background_color);
                rtv_2_3.setBackgroundResource(R.color.msg_stroke_color);
            } else {
