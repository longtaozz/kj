...
@Route(path = RouterActivityPath.Base.PAGER_PHOTO_MAIN)
public class PhotoMainActivity extends AppCompatActivity implements View.OnClickListener,
        RadioGroup.OnCheckedChangeListener, CompoundButton.OnCheckedChangeListener {
    private final static String TAG = PhotoMainActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FullyGridLayoutManager manager = new FullyGridLayoutManager(PhotoMainActivity.this, 4, GridLayoutManager.VERTICAL, false);
        recyclerView.setLayoutManager(manager);
        adapter = new GridImageAdapter(PhotoMainActivity.this, onAddPicClickListener);
                ...
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            ...
                            PictureSelector.create(PhotoMainActivity.this).themeStyle(themeId).openExternalPreview(position, selectList);
                            break;
                        case 2:
                            // 预览视频
                            PictureSelector.create(PhotoMainActivity.this).externalPictureVideo(media.getPath());
                            break;
                        case 3:
                            // 预览音频
                            PictureSelector.create(PhotoMainActivity.this).externalPictureAudio(media.getPath());
                            break;
                    }
                }
            }
        ...
        permissions.request(Manifest.permission.READ_EXTERNAL_STORAGE,
            ...
            public void onNext(Boolean aBoolean) {
                if (aBoolean) {
                    PictureFileUtils.deleteCacheDirFile(PhotoMainActivity.this);
                } else {
                    Toast.makeText(PhotoMainActivity.this,
